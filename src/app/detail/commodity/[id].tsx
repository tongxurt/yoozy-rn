  ...
  return (
    <View className="flex-1 bg-background">
      ...
      >
        ...
        <View className="absolute top-0 left-0 right-0 z-50 flex-row items-center justify-end px-4 pt-5 pb-4">
          <View>
            <TouchableOpacity
            ...
            <View className="gap-4">
              <View className="flex-row items-center justify-between">
                ...
                <View className="px-3 py-1 rounded-full bg-primary/10 border border-primary/5">
                  <Text className="text-primary text-xs font-medium">
                    {selectedItem.chances.length} 个机会点
                  </Text>
                </View>
              </View>
              ...
              >
                {selectedItem.chances.map((chance: any, idx: number) => (
                  ...
                  >
                    <View className="rounded-3xl p-5 bg-plain">
                      {/* 核心卖点 */}
                              ...
                              ([key, value]: [string, any]) => {
                                ...
                                return (
                                  <View key={key} className="flex-row gap-3">
                                    <Text className="text-sm text-white/80 leading-5 font-medium pl-12">
                                      {displayValue}
                                    </Text>
                                  </View>
                                );
